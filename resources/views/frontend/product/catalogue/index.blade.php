    ...
    <div class="uk-container uk-container-center">
        ...
        <div class="panel-body">
                ...
                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                    <div class="filter-widget">
                        <div class="uk-flex uk-flex-middle">
                            ...
                            <div class="filter-button ml10 mr20">
                                <a href="" class="btn-filter uk-flex-middle">
                    ...
                    <div class="sorting">
                        <select name="sort" class="nice-select filtering" style="display: none;">
                            ...
                            <option value="title:asc">Tên sản phẩm từ A-Z</option>
                            <option value="title:desc">Tên sản phẩm từ Z-A</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="product-list">
                <div class="uk-grid uk-flex-medium">
