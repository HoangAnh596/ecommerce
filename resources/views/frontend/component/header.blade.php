    ...
    <div class="header-upper">
        <div class="uk-container uk-container-center">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <div class="sitelink">
                    @if(isset($menus['sitelink-menu']))   
                    <ul class="uk-list uk-clearfix uk-flex uk-flex-middle">
                        @foreach($menus['sitelink-menu'] as $key => $val)
                        @php
                ...
                <div class="header-widget">
                    <div class="uk-flex uk-flex-middle">
                        <div class="call-us">Cần hỗ trợ? Gọi cho chúng tôi: <a href="tel:{{ $system['contact_hotline'] }}" title="">{{ $system['contact_hotline'] }}</a></div>
                        @if(isset($languages))
                        <div class="language">
                            ...
                            <ul class="uk-list uk-clearfix language-dropdown">
                                ...
                                <li><a href="" title="{{ $val->name }}">{{ $val->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        @endif
                            ...
                            <div class="uk-width-large-1-2 mb10">
                                <div class="categories-item">
                                    <a href="" title="" class="uk-flex uk-flex-middle">
                                        <img src="{{ asset('frontend/resources/img/categories-' . ($i + 1) . '.png') }}" alt="">
                                        <span class="title">{{ $cat }}</span>
                                        <span class="total">{{ rand(0, 20) }}</span>
                                    </a>
                                </div>
                            </div>
                            @endforeach
