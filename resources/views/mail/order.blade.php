    ...
    <div class="cart-success">
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            ...
                            <tr class="total_payment">
                                ...
                                <td>{{ convert_price($data['cartCaculate']['cartTotal'], true) }} đ</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
        ...
        <div class="panel-foot">
            ...
            <div class="checkout-box">
                ...
                <div>Hình thức thanh toán: <span>{{ array_column(__('payment.method'), 'title', 'name')[$data['order']->method] ?? '-'}}</span></div>
            </div>
        </div>
    </div>
</body>
