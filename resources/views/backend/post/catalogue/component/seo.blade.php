    ...
    <div class="ibox-title">
        ...
        <div class="ibox-content">
            <div class="seo-container">
                ...
                <div class="canonical">{{ (old('canonical', ($postCatalogue->canonical) ?? '')) ? config('app.url').old('canonical', ($postCatalogue->canonical) ?? '').config('apps.general.suffix') : 'https://duong-dan-cua-ban.html' }}</div>
