    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="panel-description">
                ...
                <p>+ Bạn có thể thay đổi vị trí hiển thị của menu bằng cách <span class="text-success">kéo thả</span> menu đến vị trí mong muốn</p>
            ...
            <div class="ibox">
                <div class="ibox-title">
                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                        ...
                        <a class="custom-button" href="{{ route('menu.editMenu', ['id' => $id]) }}">Cập nhật Menu cấp 1</a>
                    </div>
                </div>
