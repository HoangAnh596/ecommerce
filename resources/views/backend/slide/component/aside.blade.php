    ...
    <div class="ibox-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @include('backend.slide.component.checkbox', ['key' => 'arrow', 'label' => 'Mũi tên'])
                <div class="setting-item">
                    <div class="uk-flex uk-flex-middle">
...
<div class="ibox slide-setting slide-advance">
    ...
    <div class="ibox-content">
        @include('backend.slide.component.checkbox', ['key' => 'autoplay', 'label' => 'Tự động chạy'])
        @include('backend.slide.component.checkbox', ['key' => 'pauseHover', 'label' => 'Dừng khi <br> di chuột'])
        <div class="setting-item">
            <div class="uk-flex uk-flex-middle">
